...
const ProfesorSidebar = ({ currentScreen, onNavigate }: ProfesorSidebarProps) => {
  const navigation = useNavigation<any>();
  const route = useRoute();
  const { logout } = useAuth();

  const menuItems = [
    { name: 'Dashboard', screen: 'DashboardProfesor' },
    { name: 'Listado Clases', screen: 'ListadoClases' },
    { name: 'Asistencia', screen: 'Asistencia' },
    { name: 'Planificación', screen: 'Planificacion' },
    { name: 'Listado Alumnos', screen: 'ListadoAlumnos' },
  ];
